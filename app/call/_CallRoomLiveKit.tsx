/**
 * LiveKit call UI. Loaded only when NOT in Expo Go (avoids "package doesn't seem to be linked").
 * In Expo Go we show a fallback from [id].tsx instead.
 */
        ...
        <View style={styles.videoContainer}>
          ...
          {isVideoEnabled && isTrackReference(localCamera) && (
            <View style={styles.localVideo}>
              <VideoTrack trackRef={localCamera} mirror style={styles.localVideoTrack} />
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  statusText: { fontSize: 18, fontWeight: '600', color: '#fff', marginBottom: 8 },
  listingTitle: { fontSize: 14, color: 'rgba(255,255,255,0.8)', textAlign: 'center' },
  userInfo: { alignItems: 'center', flex: 1, justifyContent: 'center' },
  userAvatar: {
    width: 120,
    height: 120,
    borderRadius: 60,
  ...
  userName: { fontSize: 28, fontWeight: '600', color: '#fff', textAlign: 'center', marginBottom: 8 },
  callType: { fontSize: 16, color: 'rgba(255,255,255,0.8)', textAlign: 'center' },
  controls: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginBottom: 40, gap: 20 },
  controlButton: {
    width: 56,
    height: 56,
    borderRadius: 28,
  ...
  activeControl: { backgroundColor: 'rgba(255,255,255,0.3)' },
  recordingControl: { backgroundColor: 'rgba(244,67,54,0.35)', borderColor: 'rgba(244,67,54,0.6)' },
  endCallContainer: { alignItems: 'center', marginBottom: 20 },
  endCallButton: {
    width: 70,
    height: 70,
    borderRadius: 35,
  ...
  recordingText: { fontSize: 14, color: '#fff', opacity: 0.9, marginBottom: 6, marginTop: -8 },
  privacyNote: { fontSize: 12, color: 'rgba(255,255,255,0.6)', textAlign: 'center' },
  videoContainer: { flex: 1, width: '100%', position: 'relative', justifyContent: 'center', alignItems: 'center' },
  remoteVideo: {
    flex: 1,
    width: '100%',
  ...
  remoteVideoTrack: { width: '100%', height: '100%', borderRadius: 12 },
  remoteVideoFallback: { justifyContent: 'center', alignItems: 'center' },
  remoteVideoPlaceholder: { width: 120, height: 120, borderRadius: 60, marginBottom: 12 },
  remoteVideoText: { fontSize: 18, fontWeight: '600', color: '#fff' },
  localVideo: {
    position: 'absolute',
    top: 20,
    right: 20,
  ...
  localVideoTrack: { width: '100%', height: '100%' },
  localVideoOff: {
    position: 'absolute',
    top: 20,
    right: 20,
...
export default function CallRoomLiveKit({ callId }: { callId: string }) {
  ...
  return (
    <View style={outerStyles.container}>
      ...
      <View style={outerStyles.backgroundOverlay} />
      <LiveKitRoom
...
const outerStyles = StyleSheet.create({
  ...
  backgroundOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.2)' },
});
