    ...
    <View key={discount.id} style={styles.card}>
      ...
      <View style={styles.cardFooter}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('/store/discount/edit/{discount.id}')}
        >
  ...
  const renderCampaignCard = (campaign: Campaign) => (
    <View key={campaign.id} style={styles.card}>
      ...
      <View style={styles.cardFooter}>
        <TouchableOpacity
          style={styles.actionButton}
          onPress={() => navigation.navigate('/store/campaign/edit/{campaign.id}')}
        >
          <Edit3 size={16} color="#6B7280" />
          <Text style={styles.actionButtonText}>Redaktə et</Text>
        </TouchableOpacity>
        ...
        options={{
          ...
          headerRight: () => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate(activeTab === 'discounts' ? 'store/discount/create' : 'store/campaign/create')}
            >
        ...
        {activeTab === 'discounts' ? (
          discounts.length > 0 ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('/store/discount/create')}
              >
          ...
          campaigns.length > 0 ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <TouchableOpacity
                style={styles.createButton}
                onPress={() => navigation.navigate('/store/campaign/create')}
              >
                <Plus size={20} color="#FFFFFF" />
