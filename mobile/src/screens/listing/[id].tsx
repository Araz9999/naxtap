...
export default function ListingDetailScreen() {
  ...
  const handleMessage = () => {
    ...
    navigation.navigate('/conversation/{seller.id}?listingId={listing.id}&listingTitle={encodeURIComponent(listing.title:language)}');
  };
        ...
        {seller && (
          <View style={styles.section}>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('/profile/{seller.id}')}
            >
