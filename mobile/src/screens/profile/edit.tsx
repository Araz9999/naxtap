...
export default function EditProfileScreen() {
  ...
  if (!isAuthenticated) {
    return (
      <View style={styles.center}>
        ...
        <TouchableOpacity style={styles.primaryButton} onPress={() => navigation.navigate('/auth/login')}>
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <TouchableOpacity style={styles.secondaryButton} onPress={() => navigation.goBack()} disabled={isSaving}>
