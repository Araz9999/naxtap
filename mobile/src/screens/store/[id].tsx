...
export default function StoreDetailScreen() {
  ...
  const handleUserPress = (userId: string) => {
    navigation.navigate('profile/[id]', { id: userId });
  };
                ...
                {isOwner && (
                  <View style={styles.ownerButtonsContainer}>
                    <TouchableOpacity
                      ...
                      onPress={() => navigation.navigate('store/add-listing/[storeId]', { storeId: store.id })}
                    >
              ...
              {isOwner && (
                <View style={styles.managementSection}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate('/store-discount-manager')}
                  >
                  ...
                  <View style={styles.managementButtons}>
                    ...
                    <TouchableOpacity
                      style={styles.managementButton}
                      onPress={() => navigation.navigate('/store-promotion')}
                    >
                      <View style={styles.managementButtonIcon}>
